...
func init() {
	licenses = append(licenses, License{
		...
		URIs:             []string{"https://fedoraproject.org/wiki/Licensing:CrystalStacker?rd=Licensing/CrystalStacker"},
	})
}
